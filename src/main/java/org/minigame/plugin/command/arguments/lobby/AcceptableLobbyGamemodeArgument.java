...
public class AcceptableLobbyGamemodeArgument extends CommandElement {

    public AcceptableLobbyGamemodeArgument(@Nullable Text key) {
        super(key);
    }

    @Nullable
    @Override
    protected GamemodeType parseValue(CommandSource src, CommandArgs args) throws ArgumentParseException {
        ...
        Optional<GamemodeType> opType = lobby.getGamemodeOptionsForVoting().stream().filter(g -> {
    ...
    public List<String> complete(CommandSource src, CommandArgs args, CommandContext context) {
        ...
        lobby.getGamemodeOptionsForVoting().stream().filter(g -> {
